...
"     ▔         ▔         ▔         ▔         ▔         ▔          "]
    ...
    assert( str( player._mobiles[0] ) == "Robot-1[on(0, 0), dir(0), error(0.0)]" )
    assert( str( player._mobiles[1] ) == "Human-2[on(1, 0), dir(0), error(0.0)]" )
    ...
    assert( len(player._mobiles) == 3 )
    assert( str( player._mobiles[0] ) == "Robot-1[on(3, 2), dir(0), goal(4, 0)-F, error(0.0)]" )
    assert( str( player._mobiles[1] ) == "Human-2[on(1, 0), dir(0), error(0.0)]" )
    assert( str( player._mobiles[2] ) == "Human-3[on(0, 0), dir(0), error(0.0)]" )
